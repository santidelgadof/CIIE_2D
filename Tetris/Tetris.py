...
def main():
    ...
    pygame.mixer.music.load('Tetris/assets/music/tetris_song.ogg')  
    ...
    while running:
        ...
        pygame.draw.rect(window, WHITE, (BOARD_OFFSET_X, 0, BOARD_WIDTH, BOARD_HEIGHT))

        pygame.draw.line(window, BLACK, (BOARD_OFFSET_X, 0), (BOARD_OFFSET_X, BOARD_HEIGHT), 2)
        pygame.draw.line(window, BLACK, (BOARD_OFFSET_X + BOARD_WIDTH, 0), (BOARD_OFFSET_X + BOARD_WIDTH, BOARD_HEIGHT), 2)
        ...
        for i in range(len(board)):
            for j in range(len(board[i])):
                if board[i][j]:
                    pygame.draw.rect(window, board[i][j], (j * BLOCK_SIZE + BOARD_OFFSET_X, i * BLOCK_SIZE, BLOCK_SIZE, BLOCK_SIZE))
        ...
        if game_over:
            ...
            buttons = [
                ...
                Boton(popup_x + popup_width // 2, popup_y + popup_height // 3 + 160, 100, 40, "CONTINUAR", fuenteGP, TRANSPARENT, YELLOW, 40, "SALIR")
            ]
